...
#endif
	public class AskGenericQuestionHTTP : BaseDataHTTP, IHTTPComms
	{
		public const string EventAskGenericQuestionChatGPTHTTPCompleted = "EventAskGenericQuestionChatGPTHTTPCompleted";
		...
		public string Build(params object[] _list)
		{
			...
			SystemEventController.Instance.DispatchSystemEvent(GameAIData.EventGameAIDataAIStartRequest, "question", question);
		...
		public override void Response(string _response)
		{
			...
			if (!ResponseCode(_response))
			{
				...
				{
					SystemEventController.Instance.DispatchSystemEvent(EventAskGenericQuestionChatGPTHTTPCompleted, false);
				}
				return;
			}
			...
			if (_requestCost) SystemEventController.Instance.DelaySystemEvent(GameAIData.EventGameAIDataCostAIRequest, 0.2f, "question", _inputTokens, _response);
			...
			{
				SystemEventController.Instance.DispatchSystemEvent(EventAskGenericQuestionChatGPTHTTPCompleted, true, _response);
			}
		}
	}

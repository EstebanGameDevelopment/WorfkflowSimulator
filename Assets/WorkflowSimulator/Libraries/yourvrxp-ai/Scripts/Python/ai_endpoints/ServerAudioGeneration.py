# ++ RUN AND CONNECT DOCKER CONTAINER ++
# jetson-containers run dustynv/audiocraft:r36.3.0
# docker ps
# docker exec -it b6a1487e0bae /bin/bash
# 
# ++ INSTALL LIBRARIES ++
# apt update
...
# docker cp ServerAudioGeneration.py b6a1487e0bae02ef5db6709713dacd8927852ea9245e159fb4ab213cfd04e957:/opt/audiocraft

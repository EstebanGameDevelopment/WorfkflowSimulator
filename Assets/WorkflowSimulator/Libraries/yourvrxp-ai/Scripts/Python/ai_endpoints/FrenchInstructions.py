...
class VoiceSettings(BaseModel):
    stability: float = Field(description="Paramètre de stabilité pour l'API ElevenLabs")
    similarity_boost: float = Field(description="Paramètre d'amélioration de similarité pour l'API ElevenLabs")
    style_exaggeration: float = Field(description="Paramètre d'exagération du style pour l'API ElevenLabs")

class ParagraphForCharacter(BaseModel):
    character: str = Field(description="Nom du personnage auquel appartient le paragraphe de texte")
    paragraph: str = Field(description="Identification numérique du paragraphe de texte")
    emotion: str = Field(description="Un mot qui représente les émotions du personnage pour interpréter correctement le paragraphe de texte à partir de cette liste d’émotions (colère, joie, tristesse, terreur, détente, peur, surprise)")
    voice_settings_elevenlabs_for_emotion: VoiceSettings = Field(description="Paramètres vocaux pour l'API ElevenLabs pour exprimer l'émotion du paragraphe")

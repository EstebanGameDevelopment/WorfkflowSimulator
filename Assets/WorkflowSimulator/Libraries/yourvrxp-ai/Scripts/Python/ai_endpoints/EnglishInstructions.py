...
class VoiceSettings(BaseModel):
    stability: float = Field(description="Stability parameter for ElevenLabs API")
    similarity_boost: float = Field(description="Similarity enhancement parameter for ElevenLabs API")
    style_exaggeration: float = Field(description="Style exaggeration parameter for ElevenLabs API")
...
class ParagraphForCharacter(BaseModel):
    ...
    emotion: str = Field(description="A word that represents the character's emotions to voice properly the text paragraph from this list of emotions (angry, cheerful, sad, terrified, relaxed, fearful, surprised)")
    voice_settings_elevenlabs_for_emotion: VoiceSettings = Field(description="Voice settings for ElevenLabs API to express the paragraph's emotion")

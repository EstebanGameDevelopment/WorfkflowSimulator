...
# mkdir -p wav_voices/en/esteban/382692530
# mkdir -p wav_voices/en/esteban/303286315

# ++ COPY TO DOCKER ++
# docker ps
# docker inspect -f   '{{.Id}}'  SHORT_CONTAINER_ID-or-CONTAINER_NAME
# docker cp ServerSpeechGeneration.py 155fe14937a4835be8bea526fdffc805633d8af143cd4ffbf80e8c2da390e10b:/home
# --ENGLISH-- 
# for file in *.ogg; do
#   docker cp "$file" 155fe14937a4835be8bea526fdffc805633d8af143cd4ffbf80e8c2da390e10b:/home/wav_voices/en/esteban/382692530
# done
# for file in *.ogg; do
#   docker cp "$file" 155fe14937a4835be8bea526fdffc805633d8af143cd4ffbf80e8c2da390e10b:/home/wav_voices/en/esteban/303286315
# done
...
# docker inspect -f   '{{.Id}}'  SHORT_CONTAINER_ID-or-CONTAINER_NAME
# --ENGLISH--
# files=$(docker exec 155fe14937a4835be8bea526fdffc805633d8af143cd4ffbf80e8c2da390e10b sh -c 'ls /home/wav_voices/en/esteban/382692530/*.ogg')
# for file in $files; do
#    filename=$(basename "$file")
#    docker cp 155fe14937a4835be8bea526fdffc805633d8af143cd4ffbf80e8c2da390e10b:"$file" "en/esteban/382692530/$filename"
# done
# files=$(docker exec 155fe14937a4835be8bea526fdffc805633d8af143cd4ffbf80e8c2da390e10b sh -c 'ls /home/wav_voices/en/esteban/303286315/*.ogg')
# for file in $files; do
#    filename=$(basename "$file")
#    docker cp 155fe14937a4835be8bea526fdffc805633d8af143cd4ffbf80e8c2da390e10b:"$file" "en/esteban/303286315/$filename"
# done
